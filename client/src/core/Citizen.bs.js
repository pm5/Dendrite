...
import * as Photo from "./Photo.bs.js";
...
function t_encode(v) {
  return Js_dict.fromArray([
              ...
              [
                "photo",
                Decco.arrayToJson(Photo.t_encode, v.photo)
              ]
            ]);
}
    ...
    if (infections.TAG === /* Ok */0) {
      ...
      if (vaccinations.TAG === /* Ok */0) {
        ...
        if (immunities.TAG === /* Ok */0) {
          var photo = Decco.arrayFromJson(Photo.t_decode, Belt_Option.getWithDefault(Js_dict.get(dict$1, "photo"), null));
          if (photo.TAG === /* Ok */0) {
            return {
                    TAG: /* Ok */0,
                    _0: {
        ...
        var e$1 = immunities._0;
        return {
                TAG: /* Error */1,
                _0: {
                  path: ".immunities" + e$1.path,
                  message: e$1.message,
                  value: e$1.value
                }
              };
      }
      var e$2 = vaccinations._0;
      return {
              TAG: /* Error */1,
              _0: {
                path: ".vaccinations" + e$2.path,
                message: e$2.message,
                value: e$2.value
              }
            };
    }
    var e$3 = infections._0;
    return {
            TAG: /* Error */1,
            _0: {
              path: ".infections" + e$3.path,
              message: e$3.message,
              value: e$3.value
            }
          };
